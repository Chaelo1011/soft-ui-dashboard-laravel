              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Contraseña" aria-label="Contraseña" aria-describedby="password-addon">
                      @error('password')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                {{-- <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <small class="text-muted">¿Olvidaste tu contraseña? 
                    <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">Restablece tu contraseña</a>
                  </small>
